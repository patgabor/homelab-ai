...
# size = 1360.00 MiB (131072 cells,  10 layers,  1/1 seqs), K (q8_0):  680.00 MiB, V (q8_0):  680.00 MiB
# size = 2380.00 MiB (229376 cells,  10 layers,  1/1 seqs), K (q8_0): 1190.00 MiB, V (q8_0): 1190.00 MiB
# size = 2720.00 MiB (262144 cells,  10 layers,  1/1 seqs), K (q8_0): 1360.00 MiB, V (q8_0): 1360.00 MiB

# 1024 2048 3072 4096 5120 6144 8192 10240 12288 14336 16384 20480 24576 28672 32768

LLAMA_CACHE="${CACHE_DIR}/${MODEL}" llama-server --hf-repo "${MODEL}" \
    --parallel 1 --no-mmap --no-warmup \
    --fit on --fit-target 4096 \
    --ctx-size 229376 --cache-type-k q8_0 --cache-type-v q8_0 \
    --cache-ram 16384 \
